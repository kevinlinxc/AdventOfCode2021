// I think this is shit but it was good practice
import java.io.*;
import java.util.*;
...
public class Day4p2 {
    public static void main(String[] args) {
        ...
        List<Integer> alreadyBingod = new ArrayList<>();
        int lastIndex = 0;
        int lastScore = 0;
        for (String bingoNum: bingoNums){
            ...
            for (BingoGrid grid : grids){
                ...
                if (bingo){
                    if (!alreadyBingod.contains(grid.index)){
                        alreadyBingod.add(grid.index);
                        lastIndex = grid.index;
                        lastScore = grid.getScore(bingoNum);
                        System.out.println("Bingo2 found in: " + grid.index + " with score: " + lastScore);
        ...
        System.out.println("Last index: " + lastIndex + " Score: " + lastScore);
